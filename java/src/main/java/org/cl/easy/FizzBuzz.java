...
public class FizzBuzz {
    ...
    // ---------------------- SOLUTION 1 -----------------------------//
    public List<String> fizzBuzzGenerator_solution1(int n) {
    ...
    public List<String> fizzBuzzGenerator_solution2(int n) {
        List<String> fizzBuzzResult = new ArrayList<>();
        for (int i = 1; i <= n; i++) {
    ...
    public List<String> fizzBuzzGenerator_solution3(int n) {
